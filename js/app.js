...
function playSoundEffect(weatherCondition) {
  switch (weatherCondition) {
    case 'rainy':
      audioElement.src = 'Sounds/Light-rain.mp3';
      break;
    case 'thunderstorm':
      audioElement.src = 'Sounds/natural-thunder.mp3';
      break;
    case 'sunny':
      audioElement.src = 'Sounds/Sunny.mp3';
      break;
    case 'clear sky':
      audioElement.src = 'Sounds/Sunny.mp3';
      break;
    ...
    case 'scattered clouds':
      ...
      break;
    case 'light snow':
      audioElement.src = 'Sounds/wind-cold.mp3';
      break;
    case 'heavy snow':
      audioElement.src = 'Sounds/wind-cold.mp3';
      break;
    case 'haze':
      ...
      break;
    case 'drizzle':
      audioElement.src = 'Sounds/Drizzle.mp3';
      break;
    default:
      // Handle other weather conditions or do nothing
  }
...
export const updateWeather = function (lat, lon) {
  ...
  */
  ...
  fetchData(url.currentWeather(lat, lon), async function (currentWeather) {
   ...
   const weatherCondition = currentWeather.weather[0].description.toLowerCase();
   playSoundEffect(weatherCondition);

   /* const weatherData = {
     location: 'New York',
     temperature: parseFloat(temp).toFixed(1),
     conditions: description,
     sunrise: module.getTime(sunriseUnixUTC, timezone),
     sunset: module.getTime(sunsetUnixUTC, timezone),
     humidity: `${humidity}%`,
    ...
    fetchData(url.forecast(lat, lon), function(forecast) {
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        windLi.innerHTML = `
         <div class="card card-sm slider-card">
           ...
           <img src="./images/weather_icons/direction.png" width="48" height="48" loading="lazy" alt="direction" class="weather-icon" style="transform: rotate(${windDirection-180}deg)">
      ...
      */
      ...
      /*function saveWeatherData(weatherData) {
        ...
        const filePath = 'E:/Online Class/3-1/Lab/CSE 3100/Weather Forecaster/Data/' + filename;
